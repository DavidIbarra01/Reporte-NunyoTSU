...
En esta etapa, comence a desarrollar el documento SRS. Aqui cometi el error de redactar este documento en la etapa de desarrollo del proyecto, sin embargo, al estar ganando experiencia, es normal darse cuenta de los pequeños detalles durante el trayecto. Dentro del documento SRS viene todo el contenido relacionado al proyecto, desde el alcance y el publico al que esta dirigido el proyecto, hasta los requerimientos legales que debe respetar la agencia para no comprometer los datos confidenciales de los trabajdores de la agencia a la hora de estar utilizando la plataforma. Dentro del documento SRS, vienen los requisitos funcionales y no funcionales. En cada Requisito funcional, he redactado una historia de usuario, junto con sus criterios de aceptacion con la finalidad de reducir ambiguedades y explicar a detalle el comportamiento de los usuarios al estar ejecutando esos requisitos funcionales. Dentro del propio documento, se definen todos los diagramas que he realizado, modelo de datos, requisitos, marco legal y todo lo que tenga que ver con el desarrollo del proyecto.
